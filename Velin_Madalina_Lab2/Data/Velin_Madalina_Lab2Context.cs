...
namespace Velin_Madalina_Lab2.Data
{
    public class Velin_Madalina_Lab2Context : DbContext
    {
        ...
        public DbSet<Velin_Madalina_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Velin_Madalina_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Velin_Madalina_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
